...
train_X, test_X, train_y, test_y = train_test_split(dfnormal.drop(columns=["risco"]), dfnormal.risco, test_size=1/7.0, random_state=0)
...
train_X, test_X, train_y, test_y = train_test_split(newdf.drop(columns=["risco"]), newdf.risco, test_size=1/7.0, random_state=0)
...
roc_auc(DT2, X_train, y_train, X_test=X_test, y_test=y_test, classes=['0', '1', '2']);
