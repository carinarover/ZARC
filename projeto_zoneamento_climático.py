...
col_names = X_train.iloc[:,:4].columns
col_names

transformar = X_train.iloc[:,:4]
...
X_train = pd.concat([df_s, col], axis=1)
...
col_names2 = X_test.iloc[:,:4].columns
col_names2

transformar2 = X_test.iloc[:,:4]
...
# Concatenando os dados normalizados
X_test = pd.concat([df_s2, col2], axis=1)
